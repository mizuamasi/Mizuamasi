...
export function toggleMic() {
    isMicOn = !isMicOn;
    document.getElementById('toggle-mic').innerHTML = isMicOn ? '<i class="fas fa-microphone-slash"></i>' : '<i class="fas fa-microphone"></i>';
    if (isMicOn) {
        startMic();
    } else {
        stopMic();
...
export function getAudioDataArray() {
